...
function preload(){
backgroundImg = loadImage("fundonovo.png");
Owenimg = loadImage("icon_12.png");
}
//////////////////

function setup(){
Canvas = createCanvas(1200, 1280);
Owen = createSprite(600,900,10,10);
...
invisibleGround = createSprite(660,960,1400,5);
